...
internal sealed class ChannelRoleOverride { public Guid SpaceId { get; set; } public Guid ServerId { get; set; } public Guid RoleId { get; set; } public string PermissionCode { get; set; } = string.Empty; public PermissionEffect Effect { get; set; } }
internal sealed class ChannelUserOverride { public Guid SpaceId { get; set; } public Guid ServerId { get; set; } public Guid UserId { get; set; } public string PermissionCode { get; set; } = string.Empty; public PermissionEffect Effect { get; set; } }
