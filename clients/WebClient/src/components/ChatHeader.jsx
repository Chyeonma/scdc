...
export function ChatHeader({ title, topic, icon = '#', connectionState = 'online', showMemberList, onToggleMemberList, showThreads, onToggleThreads, showPinned, onTogglePinned, searchQuery, onSearchChange, isDirectMessage = false, onOpenGroupSettings, statusDot = null }) {
  return (
    <header className="chat-header">
      ...
      <div className="chat-header__actions">
        ...
        <div className="chat-header__search"><span className="search-icon">🔍</span><input type="search" placeholder="Tìm kiếm..." value={searchQuery || ''} onChange={(event) => onSearchChange?.(event.target.value)} className="search-input" /></div>
